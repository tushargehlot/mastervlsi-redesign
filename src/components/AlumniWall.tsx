  ...
  return (
    ...
    >
      <div className="relative aspect-square rounded-xl overflow-hidden bg-gradient-to-br from-surface-1 to-surface-2 mb-3">
        {a.photo ? (
          <img src={a.photo} alt={`${a.name} — ${a.company}`} loading="lazy" referrerPolicy="no-referrer" crossOrigin="anonymous" className="absolute inset-0 h-full w-full object-cover" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = "none"; }} />
        ) : (
