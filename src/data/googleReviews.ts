...
export const GOOGLE_REVIEWS: GoogleReview[] = [
  ...
  { name: "Lakshmi Iyer", initials: "LI", rating: 4, date: "4 months ago", text: "Excellent technical depth in PD and STA. Would love a couple more weekend revision sessions, but otherwise top notch." },
  ...
  { name: "Anita Krishnan", initials: "AK", rating: 5, date: "1 month ago", text: "The physical design labs on real 7nm blocks — where else does a student get that access? Cadence Innovus, ICC2 running 24/7." },
